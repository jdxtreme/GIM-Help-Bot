module.exports = (g) =>
{
	...
	register_role(["caino_arukat", "cainoarukat", "caino", "arukat", "ca", "1606"], "Neutral", "Caino Arukat", {subCat: "Killing"}, (e) =>
	{
		...
		e.addField("Generators:", "*Each generator produces X a colour of Energy each turn you take, where X is the orthogonal distance between that generator and the specified corner of Dai'ar Kul-ya (the least number of orthogonal moves required to get from one to the other) each night.*\n> - Mine: Red, Top-Front-Right\n> - Port: Blue, Top-Back-Left\n> - Factory: Yellow, Bottom-Front-Left\n> - Farm: Green, Bottom-Back-Right");
	...
	register_role(["forgotten", "forgor", "1622"], "Last", "Forgotten", {subCat: "Espionage"}, (e) =>
	{
		e.setDescription("Post 1622");

		e.addField("Alignment", "Unique Last Espionage", true);
		e.addField("Attack", "Powerful", true);
		e.addField("Defense", "Basic", true);
	...
	register_role(["=random_faction", "=randomfaction", "=rfaction", "1647"], "Random", "Random Faction", {subCat: "Support"}, (e) =>
	{
